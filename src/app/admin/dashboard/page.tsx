            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold">
                    {lessons.reduce((sum, lesson) => sum + lesson.reservations.length, 0)}
                  </span>
                </div>
              </div>
            </div>
            ...
            {selectedLesson && (
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-600">
                      予約: {selectedLesson.reservations.length}/{selectedLesson.maxCapacity}
                    </p>
                  </div>
                  ...
                  {selectedLesson.reservations.length > 0 && (
                    <div>
                      ...
                      <div className="space-y-2 max-h-40 overflow-y-auto">
                        {selectedLesson.reservations.map((reservation: Reservation) => (
