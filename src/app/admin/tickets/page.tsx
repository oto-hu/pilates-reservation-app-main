        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 sm:h-16 space-y-3 sm:space-y-0">
            <div className="flex items-center">
              <Ticket className="h-6 w-6 sm:h-8 sm:w-8 text-blue-600 mr-3" />
              <div>
                <h1 className="text-lg sm:text-xl font-semibold text-gray-900">
                  <span className="sm:hidden">チケット</span>
                  <span className="hidden sm:inline">チケット管理</span>
                </h1>
                <p className="text-xs sm:text-sm text-gray-500 hidden sm:block">会員のチケット残数を確認し、新しいチケットを付与できます</p>
              </div>
            </div>
            <div className="flex items-center">
